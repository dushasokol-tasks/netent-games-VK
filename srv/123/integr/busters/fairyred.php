		...
		if ($busterActive[1] > 0 and ($busterActive[0] == 6 or $busterActive[0] == 7 or $busterActive[0] == 8 or
			...
			if ($busterActive[0] == 8) {
				if ($lastAction == 'spin' and $_GET['action'] == "spin") {
					...
					if ($temp == 0)	$lastAction = "random_wilds_spin";
					elseif ($temp == 1) $lastAction = "cluster_spin";
			...
			if ($busterActive[0] == 10) {
				if (($lastAction == 'spin' or $lastAction == "random_wilds_spin" or $lastAction == "cluster_spin" or $lastAction == "symbol_transform") and $_GET['action'] == "spin") {
					$busterActive[1]--;
				}
